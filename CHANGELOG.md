...
### Changed
- `/dashboard/customers` and `/dashboard/servers/[id]/stats` tables are now replaced by a stacked card list below the `sm` breakpoint (same data and actions per row), matching the pattern already used on the streams page.
